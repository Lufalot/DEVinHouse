...
class Transacao {
    ...
    transferecia() {
        if (this.valorTransacao > 300) {
            alert('Valor excede o limite máximo de 300 reais.');
            return;
        }
...
const transacaoDois = new Transacao(contaCliente, 15);

transacaoUm.deposito();
transacaoDois.transferecia();

console.log(endCliente);
console.log(cliente);
console.log(contaCliente)
console.log(transacaoUm);
console.log(transacaoDois);
